...
\Bitrix\Main\UI\Extension::load(['ui.design-tokens', 'jquery', 'otus.vacation']);
$APPLICATION->SetAdditionalCSS("/bitrix/js/intranet/intranet-common.css");

if ($arResult["permissions"]["CAN_DOWNLOAD_REPORT"] == true) {
	$button = new \Bitrix\UI\Buttons\Button([
		"color" => \Bitrix\UI\Buttons\Color::SUCCESS,
		"click" => new \Bitrix\UI\Buttons\JsHandler(
			"BX.AbsenceCalendar.chooseYear" //ссылка на функцию
		),
		"text" => "Скачать отчёт"
	]);
...
$property_enums = CIBlockPropertyEnum::GetList(Array("DEF"=>"DESC", "SORT"=>"ASC"), Array("IBLOCK_ID"=>$arParams['IBLOCK_ID'], "CODE"=>"ABSENCE_TYPE", "ID" => $absenceTypeFilter));
...
jsBXAC.Init(
	{
		'LOADER': '/bitrix/components/otus/vacation.schedule/ajax.php',
